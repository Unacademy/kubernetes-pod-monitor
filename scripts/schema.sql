CREATE TABLE IF NOT EXISTS `k8s_crash_monitor` (
...
CREATE TABLE IF NOT EXISTS `k8s_pod_crash` (
...
CREATE TABLE IF NOT EXISTS `k8s_pod_crash_notify` (
...
CREATE TABLE IF NOT EXISTS `k8s_crash_ignore_notify` (
`clustername` varchar(255) NOT NULL,
`namespace` varchar(255) NOT NULL,
